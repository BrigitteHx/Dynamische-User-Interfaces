...
// gekozenNummer = Number(prompt("Van welk getal wilt u een ruit zien?"));

// const nummerLijst = [] // const = constante waarde, kan niet veranderen
// nieuwNummer = ""

// for (nummer = 0 < gekozenNummer; i++;){
//     nieuwNummer = nummer + 1 + " ";
//     laatsteNummer = laatsteNummer + nieuwNummer
//     currentNummer = laatsteNummer.slice(0,-3)
//     // array slicing is a way to get a subarray of the given array.
//     nummerLijst[nummer] = currentNummer
